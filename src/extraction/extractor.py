...
def run_extraction():
    """
    Main function to run the invoice extraction process.
    """
    ...
    if all_invoices:
        ...
        # Use a relative path to ensure it works from the project root
        ...
        print(f"Extraction successful. Invoices saved to {filepath}")
        return filepath
    else:
